try {
    ...
    $(document).ready(function() {
        ...
        $('#change-document .item').click(function() {
            $('#change-document .item').removeClass('active-item');
